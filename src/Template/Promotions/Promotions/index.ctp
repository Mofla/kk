    ...
    <div class="row">
        ...
        <?php foreach ($promotions as $promotion): ?>
            <div class="col-md-3 text-center well" style="background-color: white;border: 1px solid lightblue; min-height: 520px">
                <img class="img-circle img-responsive" style="width: 70%; margin: auto;border: 1px solid #2d0065" src=" ../../uploads/user/<?= $promotion->user->picture_url ?>">
                <br>
                ...
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">html</div>
                <?php } ?>
                <?php if ($promotion->language_css) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">css</div>
                <?php } ?>
                <?php if ($promotion->language_javascript) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">javascript</div>
                <?php } ?>
                <?php if ($promotion->language_jquery) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">jquery</div>
                <?php } ?>
                <?php if ($promotion->language_php) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">php</div>
                <?php } ?>
                <?php if ($promotion->language_sql) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">sql</div>
                <?php } ?>
                <?php if ($promotion->language_cakephp) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">cakephp</div>
                <?php } ?>
                <?php if ($promotion->language_bootstrap) { ?>
                <div style="background-color: #2d0065; color: white;border: 1px solid white" class="btn">bootstrap</div>
                <?php } ?>
            </div>
        <?php endforeach; ?>
    </div>
